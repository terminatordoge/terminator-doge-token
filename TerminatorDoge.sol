...
/**
 *    TerminatorDoge Tokenomics
 *    totalSupply = 1 Q
 *     35% burn at launch
 *    Note:
 *      - 3% tx fee redistributed to token holders on each transaction.  
 *      - 3% liquidity fee is taken on each transaction and locked forever in the liquidity pool.
 *      - 3% cmarketing fee is taken on each transaction.
...
contract TerminatorDoge is Context,IBEP20,Ownable {
    ...
    string private constant _name = "TerminatorDoge";
